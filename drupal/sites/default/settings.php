 ...
 * @endcode
 */
$settings['hash_salt'] = 'gN0pRD88acvtu-Ci1wWaIXn3Cj8pe_8TFjynYqCPxt5-eekpV6OY9KpO2V_2cjZ5h90zY4Waig';
 ...
 */
$settings['trusted_host_patterns'] = [
  '^localhost$',  // Para aceptar solicitudes desde http://localhost
  '^127\.0\.0\.1$',  // Para aceptar solicitudes desde http://127.0.0.1 (dirección IP local)
  '^::1$',  // Para aceptar solicitudes desde http://[::1] (IPv6 localhost)
  '^tusitio\.com$',  // Dominio principal de tu sitio (ajusta según sea necesario)
  '^www\.tusitio\.com$',  // Subdominio www de tu sitio
];
...
$settings['config_sync_directory'] = 'sites/default/files/config_z2N0MTvvErb0wNmtbn4_qFDJknwfpRYmgrbySZOSY69vrVMXKLpVmhL_Ecvk10MepNnNb70IXQ/sync';
